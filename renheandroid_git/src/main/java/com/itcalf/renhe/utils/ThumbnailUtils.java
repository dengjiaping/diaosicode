...
//	}
//	
//	public static Bitmap createSmallImage(String filePath, int kind) {
//		SizedThumbnailBitmap sizedThumbnailBitmap = new SizedThumbnailBitmap();
//		Bitmap bitmap = null;
//		MediaFileType fileType = MediaFile.getFileType(filePath);
//		if (fileType != null && fileType.fileType == MediaFile.FILE_TYPE_JPEG) {
//			createThumbnailFromEXIF(filePath, 100, 100*100,
//					sizedThumbnailBitmap);
//			bitmap = sizedThumbnailBitmap.mBitmap;
//		}
//
...
//	}
//	
//	public static Bitmap createUploadImage(String filePath, int kind) {
//		SizedThumbnailBitmap sizedThumbnailBitmap = new SizedThumbnailBitmap();
//		Bitmap bitmap = null;
//		MediaFileType fileType = MediaFile.getFileType(filePath);
//		if (fileType != null && fileType.fileType == MediaFile.FILE_TYPE_JPEG) {
//			createThumbnailFromEXIF(filePath, 960, 960*960,
//					sizedThumbnailBitmap);
//			bitmap = sizedThumbnailBitmap.mBitmap;
//		}
//
...
//					return null;
//				}
//				options.inSampleSize = computeSampleSize(options, 960,
//				    960*960);
//				options.inJustDecodeBounds = false;
//
//				options.inDither = false;
