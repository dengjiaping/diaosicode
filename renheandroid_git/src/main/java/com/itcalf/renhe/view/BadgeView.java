...
//	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#CCFF0000"); //Color.RED;
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#dd563f"); //Color.RED;
	...
	private void init(Context context, View target, int tabIndex) {
		...
		badgeMarginV = badgeMarginH + (int)(context.getResources().getDimension(R.dimen.icon_margin_icon_V));
