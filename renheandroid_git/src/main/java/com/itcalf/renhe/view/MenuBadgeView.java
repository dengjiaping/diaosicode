 ...
 * @author Jeff Gilfelt
 */
public class MenuBadgeView extends TextView {
...
//	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#CCFF0000"); //Color.RED;
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#efb974"); //Color.RED;
	...
	public MenuBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public MenuBadgeView(Context context, View target) {
     ...
     */
	public MenuBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public MenuBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public MenuBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
	...
	private void init(Context context, View target, int tabIndex) {
		...
		badgeMarginV = badgeMarginH + (int)(context.getResources().getDimension(R.dimen.menu_icon_margin_icon_V));
