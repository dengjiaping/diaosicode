...
import com.itcalf.renhe.utils.HttpUtil;
   ...
   * @author wangning
   */
public class DeleteWorkInfoTask  extends BaseAsyncTask<MessageBoardOperationWithErroInfo> {
	private Context mContext;
	public DeleteWorkInfoTask(Context mContext) {
		super(mContext);
	...
	protected MessageBoardOperationWithErroInfo doInBackground(String... params) {
		...
		try
		{
			MessageBoardOperationWithErroInfo mb = (MessageBoardOperationWithErroInfo) HttpUtil.doHttpRequest(
					Constants.Http.DELETE_WORK_INFO, reqParams,
