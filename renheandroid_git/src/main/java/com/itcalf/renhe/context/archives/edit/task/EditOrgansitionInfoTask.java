...
import com.itcalf.renhe.utils.HttpUtil;
   ...
   * @author wangning
   */
public class EditOrgansitionInfoTask  extends BaseAsyncTask<MessageBoardOperation> {
	private Context mContext;
	public EditOrgansitionInfoTask(Context mContext) {
		super(mContext);
	...
	protected MessageBoardOperation doInBackground(String... params) {
		...
		try
		{
			MessageBoardOperation mb = (MessageBoardOperation) HttpUtil.doHttpRequest(
					Constants.Http.EDIT_ORGANSITION_INFO, reqParams,
