...
import com.itcalf.renhe.utils.HttpUtil;
   ...
   * @author wangning
   */
public class EditSummaryInfoSpecialtiesTask  extends BaseAsyncTask<MessageBoardOperation> {
	private Context mContext;
	private String[] strings;
	public EditSummaryInfoSpecialtiesTask(Context mContext,String[] strings) {
		super(mContext);
	...
	protected MessageBoardOperation doInBackground(String... params) {
		...
		reqParams.put("specialties", strings);// 
		try
		{
			MessageBoardOperation mb = (MessageBoardOperation) HttpUtil.doHttpRequest(
					Constants.Http.EDITSPECIALTIES, reqParams,
