...
import com.itcalf.renhe.context.relationship.selectindustry.TreeViewAdapter.TreeNode;
...
public class SuperTreeViewAdapter extends BaseExpandableListAdapter {
	...
	public SuperTreeViewAdapter(Context view,OnChildClickListener stvClickEvent,ExpandableListView expandableListView,int selectedId) {
		parentContext = view;
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		final TreeViewAdapter treeViewAdapter = new TreeViewAdapter(this.parentContext,0,expandableListView,selectedId);
